...
id, the source and target party and should allow for additional attributes. It
...
def validate_edge_query(header, records, c):
    ...
    if is_header_valid(header):
        ...
        print("Query error: Query must include 'id_hdv', 'source', 'target',"
              "and 'year' attributes")
        return None
...
def network_structure(db_file, edge_query, node_query, \
    ...
    Edges:
        ...
        Other: The combination of 'id_hdv', 'source', 'target', 'year'
